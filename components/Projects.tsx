...
export const ProjectsSection = () => {
  ...
  <section className="pb-16  sm:pt-96 sm:mt-10 md:pt-10  lg:mt-3 h-auto z-50 ">
    <div className="container w-full">
        ...
        <h2 className="font-serif text-3xl text-center md:text-5xl mt-6">Featured Projects</h2>
        <p className="text-center md:text-lg text-white/60 mt-4 max-w-md mx-auto">See how I transformed concepts </p>
